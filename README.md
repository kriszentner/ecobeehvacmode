...
### Caveats
Since Homebridge runs on a older version of Debian, you may need to change a couple functions that use `io` so this works on Go 1.15 (unless you find a newer version of Go for Debian Bullseye on the armv7l platform). You're better off using a newer version from https://go.dev/dl/. The armv6l release is backwards compatible with armv7l.
